...
/* Value used to enable the timer only in auto-reload mode- trig on fall and rise; clk thru time in pin */
#define DMTIMER_AUTORLD_NOCMP_GPOIN_ENABLE        (DMTIMER_TCLR_AR | DMTIMER_TCLR_GPO_CFG)
